...
This index lists internal-only documentation. Do not add internal docs outside `_docs/`. Update this file whenever you add, move, or archive a document.
...
- `_docs/version-control.md`
- `_docs/ERROR_HANDLING.md`
- `_docs/INDEX_STRATEGY.md`
...
## Onboarding
- `_docs/onboarding/README.md`
- `_docs/onboarding/01-environment-setup.md`
- `_docs/onboarding/02-architecture-overview.md`
- `_docs/onboarding/03-code-contribution.md`
- `_docs/onboarding/04-testing-guide.md`
- `_docs/onboarding/05-code-review-checklist.md`
- `_docs/onboarding/06-module-development.md`
- `_docs/onboarding/07-patterns-antipatterns.md`
- `_docs/onboarding/08-debugging-guide.md`
- `_docs/onboarding/access-control.md`

## Operations
- `_docs/operations/ci-troubleshooting.md`
...
- `_docs/operations/slopes-multi-workspace-operator-guide.md`
...
## Security
- `_docs/security-checklist.md`
- `_docs/security-guidelines.md`
- `_docs/security-review-8d-ml-verification.md`
- `_docs/threat-model.md`
...
- `_docs/veid-testing-infrastructure.md`
- `_docs/veid-zkproofs-security.md`

## Providers & Marketplace
- `_docs/provider-guide.md`
- `_docs/provider-daemon-lifecycle-queue.md`
- `_docs/provider-daemon-waldur-integration.md`
- `_docs/provider-domain-verification.md`
- `_docs/Domain-Verification.md`
- `_docs/hpc-billing-rules.md`
- `_docs/hpc-marketplace-e2e-test-guide.md`
- `_docs/settlement-usage-rewards.md`

## Governance & Compliance
- `_docs/data-classification.md`
- `_docs/data-retention-policy.md`
- `_docs/data-archival-guide.md`
...
- `_docs/mainnet-genesis.md`
- `_docs/verification-deployment.md`
- `_docs/validator-onboarding.md`
- `_docs/validator-veid-pipeline-guide.md`

## Training & Enablement
- `_docs/training/README.md`

## Validators
- `_docs/validators/hardware-requirements.md`
...
## Visual Assets
- `_docs/img/logo-label-black.svg`
