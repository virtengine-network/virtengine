...
const createTestChainInfo = (
  overrides: Partial<WalletChainInfo> = {},
): WalletChainInfo => ({
  chainId: "virtengine-1",
  chainName: "VirtEngine",
  rpcEndpoint: "https://rpc.virtengine.com",
  restEndpoint: "https://rest.virtengine.com",
  bech32Config: {
...
describe("estimateGas", () => {
  ...
  it("should call correct endpoint", async () => {
    ...
    expect(fetch).toHaveBeenCalledWith(
      "https://rest.virtengine.com/cosmos/tx/v1beta1/simulate",
...
describe("createTransactionPreview", () => {
  ...
  it("should return empty array for null messages", () => {
    const previews = createTransactionPreview(
