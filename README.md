...
[Bosun](https://github.com/virtengine/bosun?tab=readme-ov-file#bosun) is VirtEngine's autonomous AI agent orchestrator. It supervises fleets of AI coding agents (Codex, Copilot, Claude) with failover, crash analysis, auto-restarts, and Telegram/WhatsApp notifications.
